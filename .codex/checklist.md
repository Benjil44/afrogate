...
- [~] Add backend unit/integration tests. 176 tests across auth crypto, tokens, RBAC, reseller/wallet/quota math, billing normalizers, byte/gb math, webhook crypto, command-safety, route-scoring, SSRF, rate-limit, and static guards. Remaining: PayPal/Telegram webhook integration and transactional allocation idempotency (DB-constraint level).
