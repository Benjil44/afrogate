...
- [x] Reseller seller workspace sidebar with scoped Dashboard, Users, and Billing pages, sales charts, Users-page add-user sale action, sold-users table, and wallet selling summary.
