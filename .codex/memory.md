...
- Paid payment orders do not allocate purchased quota yet; the separate charge allocation layer must later consume paid orders idempotently before mutating customer/client quota limits.
