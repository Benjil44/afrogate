...
- Servers page now has an initial edit workflow: selecting a server opens Overview, Access, Monitoring, Interfaces, and Audit tabs. The access tab remains read-only and secret-safe until real credential storage and mutation flows exist.
