...
| `apps/dashboard/src/i18n.fa.ts` | Same keys in arabic (typed against `DashboardStrings`, so tsc enforces parity). | Modify |
...
- [ ] **Step 3: Add the same strings to arabic**
...
- [ ] **Step 4: Rename the Users nav label to Admins (arabic)**
