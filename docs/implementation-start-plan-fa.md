...
برای شروع low-resource، Vite + React سبک‌تر است و خروجی static ساده‌تری برای Nginx می‌دهد. اگر بعداً server-side rendering لازم شد، می‌توان دوباره Next.js را بررسی کرد.
