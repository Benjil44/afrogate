...
- [x] Reseller seller workspace with scoped Dashboard, Users, and Billing sidebar pages, sales charts, Users-page add-user sale action, sold-users table, and wallet selling summary.
