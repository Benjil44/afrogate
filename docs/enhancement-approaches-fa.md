...
- rewarded ads should credit small quota grants through an idempotent, daily-capped ledger; production use should verify ad-network events server-side before increasing quota.
