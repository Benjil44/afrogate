...
- payment orders should snapshot package price/volume and move through pending, paid, failed, and refunded states before any separate quota allocation event is written.
