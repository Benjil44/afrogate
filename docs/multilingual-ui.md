...
- Current language support covers English and Persian dashboard operations copy, the admin usage/billing and customer-limit-management surface, and the first VPN-client route/quota/rewarded-data/subscription-readiness surface.
