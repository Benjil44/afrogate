# PRD مانیتورینگ MVP Afrows

## هدف

هدف MVP این است که Afrows بتواند وضعیت سرورها، تونل‌ها، کیفیت مسیر، مصرف حجم، ظرفیت کاربران، و هشدارهای حیاتی را در یک داشبورد اختصاصی نمایش دهد و در تلگرام اطلاع‌رسانی کند.

این MVP جایگزین کامل Marzban یا پنل صنایی در روز اول نیست؛ اما پایه‌ی پنل اختصاصی Afrows را می‌سازد تا بعداً به نسخه enterprise قابل فروش تبدیل شود.
