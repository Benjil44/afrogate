...
- **Source revision (from manifest):** `53bff6887cf5`
- **Current HEAD:** `53bff6887cf5`
- **State:** **FRESH**
...
- **Graph artifact time (graph.json mtime):** 2026-08-20T13:32:55.646Z
- **Nodes:** 6407
- **Edges:** 15215
...
- **Weakly-connected nodes (≤1 neighbour):** 2508
...
- **→ Genuine source/doc leaves (NOT config noise):** 2284 — barrel-exported types, DTOs, mobile-app screens, and ADR/design concept nodes; reachable via the module / table / domain MOCs, so they are navigation leaves rather than documentation gaps.
...
- Weakly-connected nodes are accounted for above: 224 are config-leaf noise (not gaps); the remaining 2284 are genuine source/doc leaves reachable via the MOCs.
