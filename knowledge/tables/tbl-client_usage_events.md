...
- **Status:** **VERIFIED / MODELED** — Drizzle entity [[clientUsageEvents]]
- **Migration source:** [[0018_client_usage_events.sql]]
- **Raw table note:** [[client_usage_events]]
...
- `apps/backend/src/billing/billing.service.ts:7884  |  INSERT INTO client_usage_events (`  _(confidence 0.9)_

## Foreign keys / referencing tables
_Not represented in the current graph/bridge artifacts (bridges cover entity↔table and table↔service only)._ Authoritative source: [[0018_client_usage_events.sql]] and [[clientUsageEvents]].
