...
|-------|------|-------|------|
| `cto-architect` | CTO / principal architect, final reviewer | Opus | whole system, `.codex/memory.md` |
| `scrum-master` | Delivery coordinator, planning & records | Sonnet | `.codex/progress.md`, `checklist.md` |
...
4. `cto-architect` reviews the combined diff before release; scrum-master updates `.codex/` and bumps version.
...
- Diagnosis matrix + status: `docs/afrows-fix-roadmap.md`. Session record: `.codex/progress.md` (2026-07-24).
...
- Read `AGENTS.md` + `.codex/` before changing code.
