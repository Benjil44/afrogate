...
import { Activity, Archive, Bell, CreditCard, Gauge, LogIn, Network, Receipt, Route, Router as RouterIcon, ScrollText, Server, Settings as SettingsIcon, Store, Users, UserRound, Wallet, Waypoints, Workflow } from 'lucide-react';
