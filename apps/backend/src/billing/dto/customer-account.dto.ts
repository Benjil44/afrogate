...
export class CreateCustomerAccountDto {
  ...
  /** v2 self-serve registration: phone stored in clear (admin-visible, names the config). */
  @IsOptional()
  @IsString()
  @MaxLength(32)
  phone?: string | null;

  /** v2: the account's own unique referral code (generated by the rewards engine). */
  @IsOptional()
  @IsString()
  @MaxLength(16)
...
export class UpdateCustomerAccountDto {
  ...
  /** v2: edit the stored (clear) phone. */
  @IsOptional()
  @IsString()
  @MaxLength(32)
  phone?: string | null;
...
export class AdjustCustomerGemsDto {
